...
<div id="j-main-container" class="span10">
	...
	<ul class="fix-content">
		<?php foreach ($this->tablesOptimized as $tableOptimized) : ?>
			<div class="alert alert-success">
				<?php echo JText::sprintf('COM_NENO_ISSUES_OPTIMIZE_TABLE_MESSAGE', $optimizationRecord->recordsOptimized, $tableOptimized->tableName); ?>
			</div>
		<?php endforeach; ?>
	</ul>
