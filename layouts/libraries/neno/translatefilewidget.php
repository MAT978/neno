...
<fieldset id="check-toggle-translate-file-<?php echo $languageFile->id; ?>"
	class="radio btn-group" data-field="<?php echo $languageFile->id; ?>">
	<!-- Translate -->
	<input class="check-toggle-translate-table-radio" type="radio"
		id="check-toggle-translate-table-<?php echo $languageFile->id; ?>-1"
		name="jform[check-toggle-translate-table]"
		value="1" <?php echo ($languageFile->translate == 1) ? 'checked="checked"' : ''; ?>>
	<label for="check-toggle-translate-table-<?php echo $languageFile->id; ?>-1"
	...
	<!-- Do not translate -->
	<input class="check-toggle-translate-table-radio" type="radio"
		id="check-toggle-translate-table-<?php echo $languageFile->id; ?>-0"
		name="jform[check-toggle-translate-table]"
		value="0" <?php echo ($languageFile->translate == 0) ? 'checked="checked"' : ''; ?>>
	<label for="check-toggle-translate-table-<?php echo $languageFile->id; ?>-0"
