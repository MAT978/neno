		...
		<div class="span6 lefteditor-wrapper editor-wrapper">
			<?php if (!$translation->deleted): ?>
				<div class="copylinks pull-right">
					<a href="javascript:void(0);" class="copy-string-link"><span
							class="icon-copy"></span><?php echo JText::_('COM_NENO_EDITOR_COPY_LINK'); ?></a>
					&nbsp;
					<a href="javascript:void(0);" class="translate-string-link"><span
							class="icon-comments-2"></span><?php echo JText::_('COM_NENO_EDITOR_TRANSLATE_LINK'); ?></a>
				</div>
			<?php endif; ?>
